...
HypHIPhase0DetectorConstruction::HypHIPhase0DetectorConstruction(const THypHi_Par& _par) : HypHIVDetectorConstruction(_par), fCheckOverlaps(true)
{}
...
G4VPhysicalVolume* HypHIPhase0DetectorConstruction::Construct()
{
  ...
  new TGeoManager("HypHIPhase0", "Geant4 basic example HypHIPhase0a");
  gGeoManager->Import("geometry_phase0.root");
